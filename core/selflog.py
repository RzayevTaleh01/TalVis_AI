...
WHY THIS EXISTS
    Everything TalVis knows about its own failures went to stdout. If it was
    ...
    could not see it was TalVis: the model heard "something went wrong" from
...
# journal; this log is for TalVis's own faults.
